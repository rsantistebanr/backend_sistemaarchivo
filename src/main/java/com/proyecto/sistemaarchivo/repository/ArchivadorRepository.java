...
public interface ArchivadorRepository extends JpaRepository<Archivador, Integer> {
    ...
    @Query(value =
            "SELECT " +
            "a.*, " +
            "a.num_cuerpo AS num_cuerpo_archivador, " +
            "a.valda AS valda_archivador, " +
            "e.num_Estante AS num_estante_estante, " +
            "e.Num_cuerpo AS num_cuerpo_estante, " +
            "e.Valda AS valda_estante, " +
    ...
    @Query(value =
            ...
            "AND (:anio IS NULL OR a.año = :anio) " +
